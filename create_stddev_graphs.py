...
def main(argv=None):  # pylint: disable=unused-argument
  stddev_model_conv_num_balls_1_beta_tenth = train("model_conv_num_balls_1_beta_0.1")
  stddev_model_conv_num_balls_1_beta_half = train("model_conv_num_balls_1_beta_0.5")
  stddev_model_conv_num_balls_1_beta_one = train("model_conv_num_balls_1_beta_1.0")

  stddev_model_conv_num_balls_2_beta_tenth = train("model_conv_num_balls_2_beta_0.1")
  stddev_model_conv_num_balls_2_beta_half = train("model_conv_num_balls_2_beta_0.5")
  stddev_model_conv_num_balls_2_beta_one = train("model_conv_num_balls_2_beta_1.0")
  ...
  plt.title("Two Ball Dataset")
  plt.legend()
  plt.title("ordered standard deviation of latent encoding")
  plt.xlabel("latent variable number")
  plt.ylabel("average stddev")
  plt.savefig("two_ball_stddev.png")
